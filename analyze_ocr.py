...
def main():
    ...
    if args.delete_all_cache:
        print("⚠️  WARNING: This will delete ALL cached analyses!")
        confirm = input("Type 'DELETE ALL' to confirm: ")
        if confirm == "DELETE ALL":
            print("🗑️  Deleting all cached analyses...")
    ...
    if args.delete_cache:
        print(f"🗑️  Deleting cache for: {args.delete_cache}")
    ...
    if not args.skip_gemini:
        ...
        try:
            ...
            if gemini_analysis.get("overall_summary") == "Gemini analysis failed - using raw OCR data":
                print("⚠️ WARNING: Gemini analysis failed - using fallback structure")
        ...
        print("⏭️  Skipping Gemini analysis (using --skip-gemini)")
